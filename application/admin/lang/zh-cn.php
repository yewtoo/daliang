...
return [
    ...
    'Delete tips'                                           => '<div style="padding-left: 65px;color: red;margin-bottom: 20px;">注意：修改会影响历史记录，请谨慎修改，若ID添加错误，请删除再重新添加<p style="text-indent: 39px;">已有关联数据的不能直接删除，需先删除所有关联数据。</p></div>',
    'Download tpl'                                          => '下载模板',
];
