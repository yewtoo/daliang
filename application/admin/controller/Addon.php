 ...
 *
 * @icon fa fa-circle-o
 * @remark 可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。Uwebadmin已上线插件商店 ，你可以发布你的免费或付费插件：<a href="http://www.uweb.net.cn/" target="_blank">http://www.uweb.net.cn/</a>
 */
class Addon extends Backend
{
    ...
    public function downloaded()
    {
        ...
        if (!is_array($onlineaddons)) {
            $onlineaddons = [];
            $result = Http::sendRequest(config('uwebadmin.api_url') . '/addon/index');
            if ($result['ret']) {
