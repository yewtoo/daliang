define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'score/score/index',
                    add_url: 'score/score/add',
                    edit_url: 'score/score/edit',
                    del_url: 'score/score/del',
                    multi_url: 'score/score/multi',
                    table: 'score',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'ccategory.name', title: __('Ccategory.name')},
                        {field: 'subject.name', title: __('Subject.name')},
                        {field: 'scategory.name', title: __('Scategory.name')},
